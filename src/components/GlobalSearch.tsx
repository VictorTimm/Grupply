  ...
  return (
    <div ref={wrapperRef} className="relative w-full max-w-sm">
      <input
        ...
        className="h-10 w-full rounded-xl border border-zinc-200 bg-white px-3 text-sm outline-none transition focus:border-zinc-300 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:border-zinc-700"
      />

      {open && q.trim() ? (
        <div className="absolute left-0 right-0 top-11 z-40 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
