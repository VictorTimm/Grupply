            ...
            upcomingJoined.map((e) => (
              ...
              >
                ...
                <form action={async () => { "use server"; await leaveEventAction(e.id); }}>
                  <button
                    type="submit"
                    className="shrink-0 rounded-lg border border-zinc-200 px-2 py-1 text-xs hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900"
                  >
                    Leave
                  </button>
                </form>
            ...
            suggestedActivities.slice(0, 6).map((e) => (
              ...
              >
                ...
                <form action={async () => { "use server"; await joinEventAction(e.id); }}>
                  <button
                    type="submit"
                    className="shrink-0 rounded-lg bg-zinc-950 px-2 py-1 text-xs font-medium text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
                  >
                    Join
                  </button>
                </form>
          ...
          {!matches || matches.length === 0 ? (
            ...
            (matches as MatchRow[]).slice(0, 8).map((m) => (
              <Link
                ...
                className="flex items-center justify-between gap-3 rounded-xl border border-zinc-100 px-4 py-3 hover:bg-zinc-50 dark:border-zinc-900 dark:hover:bg-zinc-900"
              >
